...
int index_calculator(float letter, float word, float sentence);

int main(void)
{
    string text = get_string("Text: ");

    int index = index_calculator(letter_counter(text), word_counter(text), sentence_counter(text));
